...
the changes that the merge will contain.
...
You will see a directory called `.git` that contains references git uses to keep track of changes.
...
It creates the alias `origin` to refer to the original repository.
